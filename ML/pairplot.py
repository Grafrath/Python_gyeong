...
sns.pairplot(data=df, vars=['hour', 'attendance', 'weight', 'iq', 'library'])
#sns.pairplot(data=df[['hours', 'attendance', 'weight', 'iq', 'library']])
plt.show()

sns.pairplot(data=df, kind='reg') #회귀선 그리기
plt.show()